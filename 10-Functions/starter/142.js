...
function isValidIntegerInRange(value, n) {
  ...
  // Check if it's within the range [0, n]
  if (value < 0 || value > n) {
    return false;
  }
...
console.log(isValidIntegerInRange(Number('test'), 3));
console.log(isValidIntegerInRange(Number(undefined), 3));
const poll = {
  ...
  registerNewAnswer: function () {
    ...
    message = message + '(Write option number)';
    console.log(message);
    let userInput;
    do {
